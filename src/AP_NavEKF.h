...
private:
    ...
    // Tuning parameters
    void ekf_initialise_some_variables(void);
    ...
    uint16_t msecBetaMax;         // maximum number of msec between synthetic sideslip measurements
    ...
    uint32_t TASmsecMax;          // maximum allowed interval between airspeed measurement updates
